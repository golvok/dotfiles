...
mytaglist.buttons = awful.util.table.join(
                    ...
                    -- awful.button({ }, 4, function(t) awful.tag.viewnext(awful.tag.getscreen(t)) end), -- scrolling on tags
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift" }, "a", function () awful.util.spawn("/home/matt/bin/togglekeyboard") end),
    -- Audio control
